...
local HELP_ENTRIES = {
    ...
    },
    {
        ...
        a = "Yes. Set Auto Track to Health and power instead of a buff or "
          ...
          .. "pinning that group's own unit's power. They appear in the "
          .. "order you tick them, and each gets its own colour swatch if "
          .. "you want one. Show Icon turns the bar icons on or off for "
          .. "this group. Value Text picks how each number is shown: the "
