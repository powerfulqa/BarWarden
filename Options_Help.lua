...
local HELP_ENTRIES = {
    ...
    -- lead entry since it is the deep-link target.
    {
        ...
        a = "Yes. On the Groups tab of Bar Control, set Auto Track to one of "
          .. "the six choices: all buffs or all debuffs on you or your "
          .. "target, or health and power for you or for your target.\n\n"
    ...
    },
    {
        ...
        a = "Yes. Set Auto Track to Health and power instead of a buff or "
          ...
          .. "nothing.\n\n"
          .. "Always Show Mana, Rage, and Energy tick boxes let you pin a "
          .. "power you always want visible, even when it is not the one "
          .. "currently in use. They work on either choice, pinning the "
          .. "target's power on the target group. They appear in the order "
          .. "you tick them, and each gets its own colour swatch if you "
          .. "want one. Show Icon turns the bar icons on or off for this "
          .. "group. Value Text picks how each number is shown: the amount "
          .. "and the total, just the percent, or both.\n\n"
          .. "The settings for limiting or filtering a spell list (Skip If "
          .. "It Lasts Over, Only Mine, Include Always On, Skip Spells I "
          .. "Already Track, and the hidden-spells list) hide for either "
          ...
          .. "the target frame also hides the combo point display.",
    },
