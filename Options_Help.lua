...
local HELP_ENTRIES = {
    ...
    },
    {
        ...
        a = "Yes. Set Auto Track to Health and power instead of a buff or "
          ...
          .. "one you are currently using. They work on either choice, "
          .. "pinning the target's power on the target group. They appear "
          .. "in the order you tick them, and each gets its own colour "
          .. "swatch if you want one. Show Icon turns the bar icons on or "
          .. "off for this group. Value Text picks how each number is "
